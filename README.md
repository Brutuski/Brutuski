<h1 align="center">Hi, I'm Adi Sirohi</h1>
...
<a href="https://github.com/jekyll/jekyll" target="_blank"><img src="https://www.vectorlogo.zone/logos/jekyllrb/jekyllrb-icon.svg" alt="jekyll" width="40" height="40"/></a>
...
My main OS of choice is `Arch Linux` paired with a tiling windows manager but I regularly use `Windows` during work. My preferred editors are `Vim` and `VS Code`.
